...
character_skill_dot_mult = 1.728
...
def calculate_dmg(alloc, config_name, weapon, artiset):
    ...
    # ========== 第一轮伤害计算 ==========
    # 月增伤区（第一轮）
    lunar_enhanced_round1 = (1 + 6 * em_value_round1 / (2000 + em_value_round1) + 
    ...
    # ========== 第二轮伤害计算 ==========
    # 月增伤区（第二轮）
    lunar_enhanced_round2 = (1 + 6 * em_value_round2 / (2000 + em_value_round2) + 
                             artiset["lunar_enhanced"] + weapon["lunar_enhanced"] + character_lunar_enhanced)
